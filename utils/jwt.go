...
func (j *JWT) ParseToken(userToken string) (*request.CustomClaims, error) {
	token, err := jwt.ParseWithClaims(userToken, &request.CustomClaims{}, func(token *jwt.Token) (interface{}, error) {
